...
export function InfiniteCategoriesSlider() {
  return (
    <div className="rounded-md flex flex-col antialiased dark:bg-sheerpeace-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
      <InfiniteMovingCards
